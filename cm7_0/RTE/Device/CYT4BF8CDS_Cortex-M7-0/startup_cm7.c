...
__attribute__( ( noreturn ) ) extern void __main(void);
...
/* "used": this project links with -flto, and the only reference to this
 * function is the inline-asm "B SysLib_FaultHandler" in Default_Fault_Handler
 * below, which LTO cannot see -- without the attribute LTO drops the
 * definition and the link fails. */
__attribute__((used)) void SysLib_FaultHandler(uint32_t const *faultStackAddr)
{
